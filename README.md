...
主界面包含当前回合、公共供应、牌库数量、二级/一级发展卡市场、玩家状态、主动作区、预留卡区和日志区。右上角提供“卡牌图鉴”“规则介绍”“保存进度”“重新开始”。
...
![卡牌图鉴弹窗](./docs/ui-cardshowing.png)

点击“卡牌图鉴”可以查看一级发展卡、二级发展卡和机遇卡的公开牌池信息，包括卡牌种类数、总数量、属性分布、成本、开心值、单卡数量与机遇卡效果，便于玩家参考后选择更优策略。
...
每次赢取开心值大于 0 的发展卡后，程序会强制执行 1 张有放回抽取的机遇卡。属性类机遇卡会比较对应属性的永久数量，唯一最多者获得最多 2 张对应任务卡；「贫困补助」为无属性金色机遇卡，会让目前阶段得分+永久发展卡数量唯一最少的玩家获得最多 1 张万能卡。若统计并列则无人获得奖励；若可奖励资源为 0 则无奖励，属性类机遇卡供应只有 1 张时只获得 1 张。
